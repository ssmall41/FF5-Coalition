...
def run_trials(valid_parties_embeddings: list, num_parties: int, num_trials: int, eps: float) -> list:
    ...
    for t in range(num_trials):
        print(f"Trial {t} #######")
        selected_parties = select_parties_by_embeddings(valid_parties_embeddings, num_parties, eps)
